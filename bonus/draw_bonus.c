void    draw_background()
{
    ...
    while (++y < height)
    {
        ...
        floorStepX = row_distance * (ray_dirX1 - ray_dirX0) / screen_width;
        floorStepY = row_distance * (ray_dirY1 - ray_dirY0) / screen_width;
...
void    draw()
{
    ...
    //fonction draw_buffer
    //fonction clean_buffer
    //mlx_put_img
}